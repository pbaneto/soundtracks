...
sountracks1000 = pickle.load(open(os.path.join(dir, 'code/sountracks1000.pkl'), 'rb'))
no_id = []
...
def mp3(item):
    ...
    new_file_name = "/home/pdbanet/Vionlabs/datasets/soundtracks9000/mp3/" + str(item['id']) + ".mp3"
...
# sountracks1000.apply(lambda row: mp3(row) if row.name > 1111 else 0, axis = 1)
